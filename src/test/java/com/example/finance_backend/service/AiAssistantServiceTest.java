...
public class AiAssistantServiceTest {
        ...
        @Mock
        private com.example.finance_backend.repository.CategoryRepository categoryRepository;
        ...
        void setUp() {
                ...
                ConversationContextManager contextManager = new ConversationContextManager(textPreprocessor,
                                entityExtractor);
                GeminiClientWrapper geminiClient = mock(GeminiClientWrapper.class);
                ResponseGenerator responseGenerator = new ResponseGenerator();
                SpendingAnalyticsService analyticsService = new SpendingAnalyticsService(entryRepository,
                                categoryService, budgetRepository, categoryRepository);
                FinancialScoreEngine scoreEngine = new FinancialScoreEngine(entryRepository, budgetRepository,
                                analyticsService);
        ...
        void testInsert_SavesOnConfirmation() {
                ...
                // Access the geminiClient mock created in BeforeEach via reflection or just use
                // the one we know is there.
